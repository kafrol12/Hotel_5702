var nome_usuario = prompt("Boa tarde, como está?. Qual o seu nome?");
const hospedes = [];
nome_hotel();
acesso();

function nome_hotel() {
  var nome_hotel = prompt(`Por gentileza ${nome_usuario}, insira o nome do Hotel:`);
  var tratamento_dado_1 =
    nome_hotel.charAt(0).toUpperCase() + nome_hotel.slice(1);
  alert(`O hotel procurado é: ${tratamento_dado_1}`);
}
